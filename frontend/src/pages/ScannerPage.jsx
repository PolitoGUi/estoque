...
export const ScannerPage = () => {
  ...
  const handleScan = (detectedCodes) => {
    if (scanResult || !detectedCodes || detectedCodes.length === 0) return;
              ...
              <>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-2">
                    <button onClick={() => navigate(`/?view=detail&eq=${scanResult.id}&action=defeito`)}
                    ...
                    <button onClick={() => navigate(`/?view=detail&eq=${scanResult.id}&action=status`)}
                  ...
                  <button onClick={() => navigate(`/?view=detail&eq=${scanResult.id}`)}
